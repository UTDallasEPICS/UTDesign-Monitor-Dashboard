/*
  ...
  - You are about to drop the column `dash_cuid` on the `Dashboard` table. All the data in the column will be lost.
  - The required column `cuid` was added to the `Dashboard` table with a prisma-level default value. This is not possible if the table is not empty. Please add this column as optional, then populate it before making it required.
