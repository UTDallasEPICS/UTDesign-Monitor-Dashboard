<template>
    <div class="flex justify-center gap-x-4 mt-4 mb-8">
        <NuxtLink class="custom-button flex items-center justify-center px-12 py-6 text-2xl" :to="`/EditDashboard/${dashboardCuid}/1`">
            <button>
                Edit
            </button>
        </NuxtLink>
        ...
        <div class="relative">
            ...
            <div v-if="showDropdown" class="absolute left-1/2 -translate-x-1/2 w-max bg-white border border-gray-300 rounded-lg mt-2 shadow-lg w-full transition">
                <NuxtLink class="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-2xl" :to="`/EditDashboard/${dashboardCuid}/post`">
                    Post
                </NuxtLink>
                <NuxtLink class="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-2xl" :to="`/Dashboard/${dashboardCuid}/1`">
                    Preview
                </NuxtLink>
                <NuxtLink class="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-2xl" :to="`/EditDashboard/${dashboardCuid}/rename`">
                    Rename
                </NuxtLink>
            </div>
        </div>
